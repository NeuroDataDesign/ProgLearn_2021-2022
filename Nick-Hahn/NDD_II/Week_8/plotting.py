...
def plot_error(mean_error, experiment, transfer_efficiencies):
    ...
    ax1.set_ylabel("Forward Learning Efficiency", fontsize=fontsize)
    ax1.set_xlabel("Total Sample Size", fontsize=fontsize)
    ax1.tick_params(labelsize=labelsize)
    # ax1.set_yscale("log")
    ax1.yaxis.set_major_formatter(ScalarFormatter())
    ...
    top_side = ax1.spines["top"]
    top_side.set_visible(False)
    ax1.axhline(y=1, c="gray", linewidth=1.5, linestyle="dashed")

    if experiment == "XNOR":
        ax1.text(200, np.mean(ax1.get_ylim()) + 1.5, "XOR", fontsize=26)
        ax1.text(850, np.mean(ax1.get_ylim()) + 1.5, experiment, fontsize=26)
    else:
        ax1.text(200, np.mean(ax1.get_ylim()) + 1.0, "XOR", fontsize=26)
        ax1.text(850, np.mean(ax1.get_ylim()) + 1.0, experiment, fontsize=26)
    ...
    ax1.set_ylabel("Backward Learning Efficiency", fontsize=fontsize)
    ax1.set_xlabel("Total Sample Size", fontsize=fontsize)
    ax1.tick_params(labelsize=labelsize)
    # ax1.set_yscale("log")
    ax1.yaxis.set_major_formatter(ScalarFormatter())
    ...
    top_side.set_visible(False)
    ax1.axhline(y=1, c="gray", linewidth=1.5, linestyle="dashed")
    ax1.text(200, np.mean(ax1.get_ylim()) + 1, "XOR", fontsize=26)
    ax1.text(850, np.mean(ax1.get_ylim()) + 1, experiment, fontsize=26)
